      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          <div className="flex items-center justify-between mb-5 pb-3 border-b border-slate-100">
            ...
            {saveSuccess && (
              <span className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200 animate-fadeIn">
          ...
          <form onSubmit={handleSaveData} className="space-y-4 text-xs">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-100/90 text-slate-700 font-black text-sm uppercase cursor-not-allowed"
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs focus:outline-none focus:ring-2 focus:ring-campo-green-500 font-semibold"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={13}
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs font-mono font-bold focus:outline-none focus:ring-2 focus:ring-campo-green-500"
                />
                {cuitError && <p className="text-[11px] text-red-500 mt-0.5">{cuitError}</p>}
              </div>
            </div>

            {/* 1c. Contacto Comercial: Apellidos y Nombres */}
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">
                1c. Contacto Comercial: Apellidos y Nombres *
              </label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1 flex items-center gap-1">
                  ...
                  <span>1d. WhatsApp Comercial *</span>
                </label>
                <input
                  type="tel"
                  required
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-campo-green-500"
                />
              </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1 flex items-center gap-1">
                  ...
                  <span>1e. Correo Electrónico *</span>
                </label>
                <input
                  type="email"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs focus:outline-none focus:ring-2 focus:ring-campo-green-500"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs focus:outline-none focus:ring-2 focus:ring-campo-green-500 uppercase"
                />
              </div>
            </div>
            ...
            <div className="pt-4 flex justify-end">
              <button
                type="submit"
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-campo-green-600 hover:bg-campo-green-500 text-white font-bold text-xs shadow-md transition-all cursor-pointer active:scale-95"
              >
        ...
        {/* 1f. Gestión de Claves (4 cols) */}
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
              <KeyRound className="w-4 h-4 text-campo-green-600" />
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-800">
                1f. Gestión de Claves
              </h3>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 mb-5">
              ...
              <div className="font-mono font-extrabold text-campo-green-800 text-sm mb-3">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl border border-slate-300 text-xs focus:outline-none focus:ring-2 focus:ring-campo-green-500 font-mono"
                  />
                  <button
                    type="button"
          ...
          <div className="p-4 rounded-2xl bg-campo-green-50 border border-campo-green-200 text-xs text-campo-green-900">
            <div className="flex items-center gap-2 font-bold mb-1">
              <ShieldCheck className="w-4 h-4 text-campo-green-700" />
              <span>Soporte Comercial Campo Directo</span>
            </div>
            <p className="text-[11px] leading-relaxed text-campo-green-800">
